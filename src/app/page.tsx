...
// Feature Card Component - extracted above Home for better code organization
            ...
            >
              ...
              <div className="bg-background-surface rounded-2xl p-5 border border-border">
                ...
                <div className="flex items-center gap-2 text-sm" style={{ color: '#a78bfa' }}>
                  <svg className="w-4 h-4 animate-pulse" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 rounded-xl transition-colors border opacity-80 cursor-not-allowed"
                    style={{
